...
const RightSidebar = () => {
    ...
    return selectedUser && (
        <div className={`bg-[#8185B2]/10 text-black w-full overflow-y-scroll relative ${selectedUser ? 'max-md:hidden' : ""}`}>
            <div className='pt-16 flex flex-col items-center gap-2 text-xs font-light mx-auto'>
                <img src={selectedUser?.profilePic || assets.avatar_icon} alt="" className='w-20 accept-[1/1] rounded-full' />
